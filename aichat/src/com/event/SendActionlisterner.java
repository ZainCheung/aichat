...
import com.main.AiTest;
import com.main.AiTest2;
import com.main.Chatroom;
import com.plugin.TranslateTool;
import com.robot.Robot;

public class SendActionlisterner implements ActionListener {
	...
	public static SendRunnable sendMessageRunnable = new SendRunnable();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (messages.length != 0 && (!messageText.equals("\n"))) { // 如果输入内容不为空
			...
			replyThread.run();// 开始激活机器人单次回复信息线程
